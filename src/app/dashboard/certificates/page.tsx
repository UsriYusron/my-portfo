...
export default function CertificatesPage() {
  ...
  const [form, setForm] = useState({ publisher: "", yearGet: "", yearEnd: "", link: "", image: "" });
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    setForm({ publisher: "", yearGet: "", yearEnd: "", link: "", image: "" });
    fetchCerts();
  }
  ...
  return (
    ...
    */}
        ...
        <header className="mb-8">
          ...
          <p className="mt-1 text-slate-500">Koleksi semua sertifikasi dan pencapaian Anda.</p>
        </header>
